  ...
  return (
    <CustomSection className="py-8 md:py-16">
      <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-10 w-full max-w-7xl mx-auto px-4">
        ...
        {/* Right Image */}
        <div className="flex flex-col w-full md:w-2/5 mb-9 md:mb-0">
          <div className="flex-shrink-0 flex justify-center mb-2 md:mb-0">
          ...
          <span className="text-center text-xs mx-auto text-opacity-20 md:text-base text-base-content/70 font-medium">
